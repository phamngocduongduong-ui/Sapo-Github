      ...
      <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
        ...
        <div className="profile-main-layout">
          ...
          <div className="sidebar-menu-base">
            ...
            <a href="/ca-nhan/ho-so?tab=2" className={`menu-item-base ${activeTab === "2" ? "active" : ""}`}>
              <FileSignature size={18} />
              <span>Công việc & Hợp đồng</span>
            </a>
            <a href="/ca-nhan/ho-so?tab=3" className={`menu-item-base ${activeTab === "3" ? "active" : ""}`}>
              <Calendar size={18} />
              <span>Nghỉ phép & Chuyên cần</span>
            </a>
            <a href="/ca-nhan/ho-so?tab=4" className={`menu-item-base ${activeTab === "4" ? "active" : ""}`}>
              <TrendingUp size={18} />
