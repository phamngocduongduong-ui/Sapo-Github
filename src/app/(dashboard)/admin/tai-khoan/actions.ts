...
export async function ensureDefaultAdmin() {
  try {
    ...
    const ALL_MODULE_KEYS = [
      ...
      "DANH_MUC", "DM_BO_PHAN", "DM_CHI_NHANH", "DM_CHUC_VU", "DM_KHACH_HANG", "DM_NHA_CUNG_CAP", "DM_NHOM_SP", "DM_QUOC_GIA", "DM_SAN_PHAM", "DM_DON_VI_TINH", "DM_NGAN_HANG", "DM_KHO_HANG", "DM_VI_TRI",
      ...
      "THU_MUA", "TM_LENH_MUA", "TM_APPROVE", "TM_DON_MUA", "TM_DIEU_DONG", "TM_BAO_CAO", "TM_DE_NGHI", "TM_PHE_DUYET_DE_NGHI",
