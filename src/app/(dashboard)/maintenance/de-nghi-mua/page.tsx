...
export default function MaintenanceProposalPage() {
          ...
          <div className="search-container" style={{ display: "flex", gap: "0.5rem", justifyContent: "flex-start", alignItems: "center", marginTop: "0px" }}>
            ...
            {selectedProposal && (
              <>
                ...
                {selectedProposal.status !== "Hoàn thành" && selectedProposal.status !== "Đã hủy" && selectedProposal.status !== "Từ chối" && selectedProposal.status !== "Đã phê duyệt" && (
                  <button
                    type="button"
          ...
          >
            ...
            <h3 style={{ borderBottom: "1px solid #e2e8f0", padding: "16px 24px", margin: 0, background: "#fff", borderTopLeftRadius: "16px", borderTopRightRadius: "16px", fontSize: "1.25rem", fontWeight: 700, color: "#1e293b", display: "flex", alignItems: "center", gap: "8px" }}>
              {isViewMode ? (
                ...
                <span>📦 Thêm mới đề nghị mua vật tư bảo trì</span>
              )}
            </h3>
                ...
                >
                  ...
                  <div>
                    ...
                    <select 
                      ...
                      required 
                      disabled={isViewMode} 
                      defaultValue={editingProposal?.purpose || "Mua dự phòng vật tư thay thế"}
                    >
                      <option value="Mua dự phòng vật tư thay thế">Mua dự phòng vật tư thay thế</option>
                      <option value="Mua thay thế, sửa chữa ngay">Mua thay thế, sửa chữa ngay</option>
          ...
          <div className="card" style={{ maxWidth: "450px", width: "90%", padding: "2rem", display: "flex", flexDirection: "column", gap: "1rem", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", gap: "1rem" }}>
              ...
              <button 
                type="button"
                className="sapo-btn" 
                style={{ flex: 1, background: confirmUpdate.status === "Đã hủy" ? "#ef4444" : "#2563eb", justifyContent: "center" }} 
